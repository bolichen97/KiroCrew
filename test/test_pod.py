...
class TestPortAllocation:
    ...
    def test_the_scan_leaks_no_descriptors(self, tmp_path, monkeypatch) -> None:
        ...
        # the one `_plane` used to pin this plane's env vars, and undoing it here
        ...
        # Both branches must have opened: the regular file, and the directory that
        # the non-regular refusal rejects only AFTER opening it -- which is the
        # branch a leak would hide in.
