...
class TestFailurePathsDoNotLeak:
    ...
    def test_error_kind_surfaces_message(self):
        out = _line("error", {"message": "You are not logged in. Please log in."})
        with pytest.raises(KasAuthCallbackError, match="not logged in"):
            _parse_token_output(out, b"")
