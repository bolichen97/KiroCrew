...
non-empty shape with 400 `invalid_avatar`, mirroring `session_color`. The **pack tier** is pure config too (`{"kind":"pack","id":...}`) and is specified below under *Crew appearance library*. Any kind
