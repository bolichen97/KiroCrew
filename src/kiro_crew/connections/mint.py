...
read, the data-home resolution, and the outcome audit -- whose first call in a
process constructs the security event log before it can enqueue anything. The
...
async def _mint_watcher(slug: str, mcp_url: str, token: str) -> None:
    ...
    try:
        ...
        while time.monotonic() < deadline:
            ...
            if await asyncio.to_thread(grant_present, mcp_url):
