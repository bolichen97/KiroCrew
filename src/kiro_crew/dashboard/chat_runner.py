    ...
    try:
        ...
        async for event in event_stream:
            ...
            if event.kind == EVENT_TEXT_CHUNK:
                ...
                # ``exhausted`` mirrors the stop-reason branches below: a stall
                # arriving with its 3-attempt budget already spent takes the
                # "Session stuck" path, so its turn labels stall_exhausted (a
                # terminal fault) instead of the excluded recovery outcomes.
                _emit_turn_metric(
                    ...
                    exhausted=(
                        ...
                        else slot._tool_stall_retries >= 3
