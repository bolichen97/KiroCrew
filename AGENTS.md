...
| the offline OOXML engine (`office_documents/`): docx/pptx read, template create, in-place edit, format rejection | [office-document-engine](docs/system-specs/modules/office-document-engine.md) |
